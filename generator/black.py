...
class BlackPlate(LicensePlateGenerator):

    def __init__(self):
        super(BlackPlate, self).__init__()
        self.length = 5
    ...
    def generate(self):
        ...
        canvas_image = Image.new("RGBA", image.size, "BLACK")
...
if __name__ == '__main__':
    ...
    generator = BlackPlate()
    image, plate = generator.generate()
    # image.save(f'output/black_{plate}.png')
